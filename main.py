...
bot = interactions.Client("MTAzMjYzNzIyNzA0MzQwMTczOA.G04Ec-.UW1ZuKncPbUs6ADMrQoNo5KwxUxAjiG8ZzcL68",intents=interactions.Intents.DEFAULT | interactions.Intents.GUILD_MESSAGES)
